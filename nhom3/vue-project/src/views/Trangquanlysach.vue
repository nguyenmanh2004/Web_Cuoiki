  ...
  mounted() {
    if (!localStorage.getItem("books")) {
      const sampleBooks = [
        ...
        { id: 13, title: "Dragon Ball Super tập 15", author: "Akira Toriyama", category: "Truyện Manga", year: 2023, status: "Đã mượn", image: "https://i.pinimg.com/enabled_lo_mid/736x/60/1b/90/601b90e64e522854e663d5a31d8b1ba0.jpg" },
        ...
        { id: 22, title: "Doremon tập 44", author: "FuJIKO F FuJIO ", category: "Truyện tranh", year: 2022, status: "Còn sách", image: "https://i.pinimg.com/736x/22/fc/4c/22fc4c72895d331f392bd02427893b8f.jpg" },
